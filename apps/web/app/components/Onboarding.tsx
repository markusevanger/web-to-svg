  ...
  return (
    <>
      ...
      <div>
        {!isPresentation ? (
          <Link
            className="cursor-pointer inline-flex rounded-full gap-2 items-center bg-white text-brand hover:bg-brand focus:bg-brand hover:text-white focus:text-white py-3 px-6 transition-colors duration-200"
            href={link.href}
            target="_blank"
          >
            {link.title}
